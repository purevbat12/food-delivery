...
export default function Header({pageState}: propsType){
    return (
        <div>
            ...
            <h1 className="text-[#09090B] text-[24px] font-[600]">Create your account</h1>
            <p className="text-[#71717A] text-[16px] font-[400]">Sign up to explore your favorite dishes.</p>
        </div>
    )
}